...
#define IST30XX_SURFACE_TOUCH		(1)
#define IST30XX_BLADE_TOUCH		(1)
...
#define IST30XX_MAX_MT_FINGERS		(2)
...
#define tsp_info(fmt, ...)		tsp_printk(DEV_DEBUG, fmt, ## __VA_ARGS__)
...
#if SEC_FACTORY_MODE
#include <linux/i2c/ist30xxc_sec.h>
#endif
