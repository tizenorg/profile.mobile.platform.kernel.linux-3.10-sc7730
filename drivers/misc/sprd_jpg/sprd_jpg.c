    ...
    case JPG_START:
        ...
        if (ret) {
            ...
            __raw_writel((1<<3)|(1<<2)|(1<<1)|(1<<0),
                         (void *)(sprd_jpg_virt+GLB_INT_CLR_OFFSET));
        }
    ...
    case JPG_ACQUAIRE_MBIO_VLC_DONE:
        ...
        if(3 == cmd0) //MBIO
        {
            ...
            if (ret == -ERESTARTSYS) {
                ...
                printk(KERN_ERR "jpg error start  timeout\n");
                ret = __raw_readl((void *)(sprd_jpg_virt+GLB_INT_STS_OFFSET));
...
static irqreturn_t jpg_isr(int irq, void *data)
{
    ...
    if((int_status) & 0xb) // JPEG ENC
    {
        ...
        {
            __raw_writel((1<<3), (void *)(sprd_jpg_virt+GLB_INT_CLR_OFFSET));
            ret = 0;
            jpg_hw_dev.jpg_int_status |=0x8;
        ...
        {
            __raw_writel((1<<0), (void *)(sprd_jpg_virt+GLB_INT_CLR_OFFSET));
        ...
        {
            __raw_writel((1<<1), (void *)(sprd_jpg_virt+GLB_INT_CLR_OFFSET));
            jpg_hw_dev.jpg_int_status |=0x2;
