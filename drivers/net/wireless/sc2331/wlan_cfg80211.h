...
#define ENG_MAC_ADDR_PATH     "/csa/.mac.info"
#define ENG_MAC_ADDR_INFO_PATH     "/opt/etc/.mac.info"
#else /* CONFIG_MACH_SAMSUNG */
#define ENG_MAC_ADDR_PATH     "/data/misc/wifi/wifimac.txt"
#endif /* CONFIG_MACH_SAMSUNG */
#define WIFI_VERSION_FILE     "/opt/etc/.wifiver.info"
...
#define MACLIST_MODE_BLACKLIST	1
#define MACLIST_MODE_WHITELIST	2
#define MAX_NUM_MAC_FILT	8
enum wlan_mode {
	ITM_NONE_MODE,
	ITM_STATION_MODE,
	ITM_AP_MODE,
