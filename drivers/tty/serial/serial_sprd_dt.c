...
#if defined(CONFIG_BT_BCM4343)
extern void bcm_bt_lpm_exit_lpm_locked(struct uart_port *uport);
#elif defined(CONFIG_SPRD_2331)
extern void sprd_bt_lpm_exit_lpm_locked(struct uart_port *uport);
#endif

#if defined(CONFIG_BT_BCM4343) || defined(CONFIG_SPRD_2331)
...
#elif defined(CONFIG_SPRD_2331)
		sprd_bt_lpm_exit_lpm_locked(port);
#endif
}
#endif
